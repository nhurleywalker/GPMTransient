...
ax.scatter(1318.57, 2.1e-12, marker=align_marker(r"$\downarrow$", valign="top"), linewidth=0.25, color="magenta", s=50, alpha=0.2)
ax.scatter(1318.57, 1.45e-12, marker=align_marker(r"$\downarrow$", valign="top"), linewidth=0.25, color="magenta", s=50, alpha=0.5)
ax.scatter(1318.57, 0.78e-12, marker=align_marker(r"$\downarrow$", valign="top"), linewidth=0.25, color="magenta", s=50, label="GPM J1839$-$10")
...
ax.scatter(6.67*3600, 7.e-10, marker=align_marker(r"$\downarrow$", valign="top"), linewidth=0.25, color="red", s=50) #, label="1E 161348–5055")
ax.set_xlabel("$P$ / s")
