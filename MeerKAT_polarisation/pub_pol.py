...
plot, = ax1.plot(pol_data["t"], 1000.0*pol_data["ampPeakPIfit"], color="darkblue", label="L", **kwargs)
...
s = np.where(yerr < 50)
plot, = ax2.plot(pol_data["t"][s], ratio[s], color="darkblue", ls="None", label="L/I",  **kwargs)
...
ax3.axhline(zeropa-90, color='r', ls=':', lw=0.5, alpha=0.5)
#plot, = ax3.plot(pol_data["t"][s], pol_data["polAngle0Chan_deg"][s], ls="None", color="darkblue", **kwargs)
#ax3.errorbar(pol_data["t"][s], pol_data["polAngle0Chan_deg"][s], yerr=pol_data["dPolAngle0Chan_deg"][s], color="darkblue", **ewargs)
#ax3.scatter(pol_data["t"][d], pol_data["polAngle0Chan_deg"][d], marker="x", color="red", s=10)

# Repeat the plot in the range 180-360 deg
#ax3.plot(pol_data["t"][s], pol_data["polAngle0Chan_deg"][s] + 180, ls="None", color="darkblue", **kwargs)
#ax3.errorbar(pol_data["t"][s], pol_data["polAngle0Chan_deg"][s] + 180, yerr=pol_data["dPolAngle0Chan_deg"][s], color="darkblue", **ewargs)
...
ax3.plot(tp[s], pa[s], ls="None", color="darkblue", **kwargs)
ax3.errorbar(tp[s], pa[s], yerr=epa[s], color="darkblue", **ewargs)
# Repeat the plot in the range 180-360 deg
ax3.plot(tp[s], pa[s] + 180, ls="None", color="darkblue", **kwargs)
ax3.errorbar(tp[s], pa[s] + 180, yerr=epa[s], color="darkblue", **ewargs)
...
#plot, = ax4.plot(pol_data["t"][s], pol_data["phiPeakPIfit_rm2"][s], ls="None", color="darkblue",  **kwargs)
#ax4.errorbar(pol_data["t"][s], pol_data["phiPeakPIfit_rm2"][s], yerr=pol_data["dPhiPeakPIfit_rm2"][s], color="darkblue", **ewargs)
...
#plot, = ax5.plot(pol_data["t"][s], pol_data["alpha"][s], ls="None", color="darkblue",  **kwargs)
#ax5.errorbar(pol_data["t"][s], pol_data["alpha"][s], yerr=pol_data["alphaerr"][s], fmt="o", color="darkblue", **ewargs)
