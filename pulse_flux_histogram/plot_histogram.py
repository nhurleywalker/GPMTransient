...
h1 = ax1.hist(df["Peak flux density at 1 GHz (mJy)"][df["Fluence at 1 GHz (Jy s)"]>0], color='red', alpha=0.5, label="$S$", bins=nbins)
ax2 = ax1.twiny()
h2 = ax2.hist(df["Fluence at 1 GHz (Jy s)"][df["Fluence at 1 GHz (Jy s)"]>0], color='blue', alpha=0.5, label="Fluence", bins=nbins)
ax2.set_xlabel("Fluence$_\mathrm{1GHz}$ (Jy s)")
ax1.set_xlabel("Peak $S_\mathrm{1GHz}$ (mJy)")
